...
export const AppNavbar = ({ title }: Props) => {
  ...
  return (
    <>
      <header className="flex w-full h-16 sticky top-0 bg-background/95 shadow backdrop-blur supports-[backdrop-filter]:bg-background/60 dark:shadow-secondary items-center px-6 py-2">
        <NavigationMenu>
