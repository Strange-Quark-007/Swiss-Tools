...
export const DataSizeConverter = ({ from, to }: Props) => {
  const { t } = useT();
      ...
      <SplitView
        left={
          <ConverterPanel
            ...
            SelectorComponent={DataSizeSelector}
            onSample={handleSample}
            onClear={handleClear}
            onCopy={handleCopyFrom}
            onUpload={openFileDialog}
            placeholder={
              t('dataSizeConverter.fromPlaceholder', { from: DATA_SIZES[from].label }) +
              '\n' +
